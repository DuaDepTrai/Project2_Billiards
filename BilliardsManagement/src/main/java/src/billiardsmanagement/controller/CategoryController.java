...
public class CategoryController {
    ...
    private void showProductList(int categoryId) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/src/billiardsmanagement/products.fxml"));
    ...
    private void handleAddNewCategory() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/src/billiardsmanagement/add_category.fxml"));
            Parent root = loader.load();
